...
public class imagecustom_pin extends ArrayAdapter<String>{
private final Activity context;
private final String[] web1;
private final String[] web2;
private final String[] web3;

public imagecustom_pin(Activity context,
String[] web1, String[] web2, String[] web3 ) {
super(context, R.layout.imagecustom_pincode, web1);
...
View rowView= inflater.inflate(R.layout.imagecustom_pincode, null, true);
...
t3.setText(web3[position]);return rowView;
}
}
